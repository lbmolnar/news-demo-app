...
# Misc
.DEFAULT_GOAL = help
.PHONY        : help build up start down logs sh composer vendor sf cc test diff migrate phpcs phpmd phpstan
...
diff: ## Create migration based on bin/console doctrine:migrations:diff
